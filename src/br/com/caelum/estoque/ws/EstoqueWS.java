...
/**
 * This class was generated by Apache CXF 2.7.13 2020-12-10T10:21:49.829-03:00
...
public interface EstoqueWS {
	...
	public br.com.caelum.estoque.ws.ListaItens todosOsItens(
			@WebParam(name = "filtros", targetNamespace = "http://ws.estoque.caelum.com.br/") br.com.caelum.estoque.ws.Filtros filtros);
	...
	public CadastrarItemResponse cadastrarItem(
			@WebParam(partName = "parameters", name = "CadastrarItem", targetNamespace = "http://ws.estoque.caelum.com.br/") CadastrarItem parameters,
			@WebParam(partName = "tokenUsuario", name = "tokenUsuario", targetNamespace = "http://ws.estoque.caelum.com.br/", header = true) TokenUsuario tokenUsuario)
